# Security Policy for Mivio (Mivio Roku)

At Mivio, we take the security of our users and their media streaming setups very seriously. We want to ensure that Mivio remains a secure and trusted media center for the Mivio Roku Ecosystem.
...
| Version | Supported |
| ------- | --------- |
| BrightScript | :white_check_mark: Yes |
| Older Versions | :x: No |
...
4. Details of the system configuration you tested (e.g. Roku Streaming Stick 4K, Roku Ultra).
