...
### Code Style
- Follow the [BrightScript API Design Guidelines](https://www.swift.org/documentation/api-design-guidelines/).
- Use **BrightScriptUI** best practices (unidirectional data flow, state hoisting).
